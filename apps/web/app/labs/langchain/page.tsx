...
export default function LangChainPage() {
  return (
    <LabShell
      ...
      architectureLabel="LangChain on AWS"
      seeing="Flow on the left lights as each hop finishes. AWS Architecture on the right is that hop’s box — click the title for the stacked twin. Click a finished hop for passages, the formatted prompt, raw text, or parsed JSON."
    >
      <ChainPanel />
    </LabShell>
  );
