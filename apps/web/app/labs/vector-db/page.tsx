...
export default function VectorDbPage() {
  return (
    <LabShell
      ...
      seeing="A live ingest→hash→index→query→rank path with an AWS-scale map beside each step. On GitHub Pages the hash runs in the browser — no localhost API. Click a finished step for cards, dimensions, or neighbors."
    >
      <VectorPanel />
    </LabShell>
  );
