...
description: Records canned RAG, LangChain, LangGraph, and refill answers into static fixtures for the GitHub Pages demo. Use from ship-to-main or when sample questions change.
---
...
4. Only write under `apps/web/public/fixtures/{rag,langchain,langgraph,refill}/`. Do not write prompts to any other path. Do not add cloud keys.
